    ...
    <ul class="sidebar-nav" data-coreui="navigation" data-simplebar>
      ...
      <li class="nav-group">
        <a class="nav-link nav-group-toggle" href="#">
          <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path fill="var(--ci-primary-color, currentcolor)"
              d="M256 48C141.1 48 48 83.8 48 128v256c0 44.2 93.1 80 208 80s208-35.8 208-80V128C464 83.8 370.9 48 256 48zm0 48c97.2 0 160 26.5 160 32s-62.8 32-160 32S96 133.5 96 128s62.8-32 160-32zm160 96v64c0 5.5-62.8 32-160 32S96 261.5 96 256v-64c38.7 22.3 102.8 32 160 32s121.3-9.7 160-32zm0 128v64c0 5.5-62.8 32-160 32S96 389.5 96 384v-64c38.7 22.3 102.8 32 160 32s121.3-9.7 160-32z" />
          </svg>
          Knowledge Base
        </a>
        <ul class="nav-group-items compact">
